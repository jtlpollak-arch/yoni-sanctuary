...
class ParticleManager {
  ...
  void emitParticle(Offset position, Color particleColor) {
  ...
  void updateParticles(Size size) {
    ...
    for (int i = 0; i < count; i++) {
      ...
      if (hitBottom) {
        ...
        bool canSlideLeft = leftGx >= 0 && (grid![gy * gridW + leftGx] == -1);
        bool canSlideRight = rightGx < gridW && (grid![gy * gridW + rightGx] == -1);
